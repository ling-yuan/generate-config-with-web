...
function clickEvent(x, value = "") {
    ...
    // 清掉opacort为0的span
    var chi = document.getElementsByClassName("overtext")
...
outputBtn.addEventListener("click", function (event) {
    ...
    var clientX = window.innerWidth - 160;
    var clientY = 15;
    clickEvent({
        "clientX": clientX,
        "clientY": clientY
